...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#fff0f5] px-4 py-10">
      <div className="bg-white p-8 rounded-3xl shadow-xl w-full max-w-md border border-pink-100">
        ...
        <h2 className="text-2xl font-extrabold text-[#2d0f1e] text-center mb-6">Daftar Akun Baru</h2>
        ...
        {success && (
          <div className="bg-emerald-50 text-emerald-600 p-3 rounded-xl mb-4 text-sm font-medium text-center">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div>
            <label className="block text-sm font-bold text-[#7a3f58] mb-1">Nama Lengkap</label>
            <input
              type="text"
              value={fullName}
          ...
          <button
            ...
            className="w-full py-4 rounded-xl text-white font-extrabold text-sm hover:scale-[1.02] transition-transform shadow-lg disabled:opacity-70 mt-4"
        ...
        <p className="text-center text-sm font-medium text-[#7a3f58] mt-6">
          Sudah punya akun?{' '}
          <Link to="/login" className="text-[#fd86a5] font-bold hover:underline">
            Login di sini
          </Link>
        </p>
      </div>
